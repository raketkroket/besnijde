    ...
    <footer className="bg-bcn-dark text-white">
      <div className="mx-auto max-w-8xl px-5 sm:px-6 lg:px-10 py-12 lg:py-20">
        ...
        <div className="lg:hidden mb-8">
          <Logo variant="light" />
          <p className="mt-4 text-sm leading-relaxed text-white/50">Gespecialiseerde besnijdeniszorg sinds 2001.</p>
          <div className="mt-5"><LinkButton to="/afspraak" size="md" withArrow className="w-full">Afspraak maken</LinkButton></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          <div className="hidden lg:block lg:col-span-3">
            <Logo variant="light" />
            <p className="mt-5 text-sm leading-relaxed text-white/50 max-w-xs">Gespecialiseerde besnijdeniszorg sinds 2001.</p>
          ...
          <div className="lg:col-span-2">
            <FooterAccordion title="Behandelingen">
              <ul className="space-y-2 lg:space-y-2">
                <li><Link to="/besnijdenis-jongen" className="text-sm text-white/70 hover:text-white">Jongens</Link></li>
                <li><Link to="/besnijdenis-volwassen-man" className="text-sm text-white/70 hover:text-white">Mannen</Link></li>
                <li><Link to="/advies-en-correcties" className="text-sm text-white/70 hover:text-white">Advies & correcties</Link></li>
              </ul>
            </FooterAccordion>
          </div>

          <div className="lg:col-span-3">
            <FooterAccordion title="Vestigingen">
          ...
          <div className="lg:col-span-2">
            <FooterAccordion title="Informatie">
              <ul className="space-y-2">
                <li><Link to="/over-bcn" className="text-sm text-white/70 hover:text-white">Over BCN</Link></li>
                <li><Link to="/informatie-voor-artsen" className="text-sm text-white/70 hover:text-white">Voor artsen</Link></li>
                <li><Link to="/faq" className="text-sm text-white/70 hover:text-white">Downloads</Link></li>
      ...
      <div className="border-t border-white/10" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <div className="mx-auto max-w-8xl px-5 sm:px-6 lg:px-10 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 text-xs">
            <button className="font-semibold text-white px-2">NL</button>
            <span className="text-white/30">/</span>
            <button className="font-medium text-white/50 px-2 hover:text-white/70">EN</button>
          </div>
        </div>
      </div>
    </footer>
