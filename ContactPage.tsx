    ...
    <>
      <section className="pt-[80px] bg-white">
        <div className="mx-auto max-w-8xl px-6 lg:px-10 py-12 lg:py-20">
          <Reveal>
            ...
            <h1 className="mt-4 text-hero text-ink text-balance">Waar kunnen we u mee helpen?</h1>
          </Reveal>
          ...
          <Reveal stagger>
            <div className="mt-10 grid sm:grid-cols-2 gap-4 max-w-2xl">
              <Link to="/vestigingen" className="group p-8 bg-bcn-ice rounded-xl2 hover:bg-bcn-200/50 transition-colors">
                <div className="text-2xl font-bold text-bcn-deep mb-2">Ik wil een afspraak maken</div>
                <p className="text-sm text-ink-muted mb-4">Kies een vestiging en plan online een afspraak.</p>
                <span className="inline-flex items-center gap-2 text-sm font-semibold text-bcn-deep group-hover:text-bcn-blue">
                  Afspraak maken <ArrowRight size={15} className="group-hover:translate-x-1 transition-transform" />
                </span>
              </Link>
              <a href={`tel:${companyInfo.mainPhone}`} className="group p-8 bg-bcn-ice rounded-xl2 hover:bg-bcn-200/50 transition-colors">
                <div className="text-2xl font-bold text-bcn-deep mb-2">Ik heb een vraag</div>
                <p className="text-sm text-ink-muted mb-4">Bel ons of stuur een bericht via het formulier.</p>
                <span className="inline-flex items-center gap-2 text-sm font-semibold text-bcn-deep group-hover:text-bcn-blue">
                  Contact opnemen <ArrowRight size={15} className="group-hover:translate-x-1 transition-transform" />
                </span>
              </a>
            </div>
          </Reveal>
      ...
      <section className="py-16 lg:py-24 bg-bcn-ice">
        <div className="mx-auto max-w-2xl px-6 lg:px-10">
          <Reveal>
            <h2 className="text-h3 text-ink mb-6">Stuur een bericht</h2>

            <div className="mb-6 flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <Info size={16} className="text-amber-600 flex-shrink-0 mt-0.5" />
              <p className="text-sm text-amber-700">
                Demo: dit formulier wordt niet verzonden. Bij de definitieve website wordt het
                veilig gekoppeld.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold text-ink mb-2">Demo voltooid</h3>
                <p className="text-ink-muted">In de definitieve website wordt uw bericht hier veilig verzonden.</p>
                <button onClick={() => setSubmitted(false)} className="mt-6 text-sm font-semibold text-bcn-deep hover:text-bcn-blue">Nog een bericht</button>
              </div>
            ) : (
              <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-4">
                <div>
                  <label htmlFor="c-name" className="block text-sm font-semibold text-ink mb-1.5">Naam</label>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="c-phone" className="block text-sm font-semibold text-ink mb-1.5">Telefoonnummer</label>
                ...
                <div>
                  <label htmlFor="c-loc" className="block text-sm font-semibold text-ink mb-1.5">Vestiging</label>
                ...
                <div>
                  <label htmlFor="c-msg" className="block text-sm font-semibold text-ink mb-1.5">Bericht</label>
                ...
                <Button type="submit" size="md" withArrow className="w-full sm:w-auto">Verzenden (demo)</Button>
              </form>
            )}
          </Reveal>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-8xl px-6 lg:px-10">
          <Reveal>
            <h2 className="text-h3 text-ink mb-8">Algemeen contact</h2>
          </Reveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Reveal>
              <div className="p-8 border border-bcn-100 rounded-xl2 h-full">
                <h3 className="font-bold text-ink mb-1">Directie & administratie</h3>
                ...
                <div className="mt-5 pt-5 border-t border-bcn-100">
                  <div className="text-xs font-semibold uppercase tracking-wider text-ink-muted mb-3">Openingstijden</div>
            ...
            <Reveal>
              <div className="p-8 border border-bcn-100 rounded-xl2 h-full">
                ...
                <div className="mt-5"><LinkButton to="/vestigingen/amsterdam" variant="secondary" size="sm" withArrow>Locatie bekijken</LinkButton></div>
              </div>
            </Reveal>
            ...
            <Reveal>
              <div className="p-8 border border-bcn-100 rounded-xl2 h-full">
                ...
                <div className="mt-5"><LinkButton to="/vestigingen/almere" variant="secondary" size="sm" withArrow>Locatie bekijken</LinkButton></div>
              </div>
            </Reveal>
          </div>
        </div>
